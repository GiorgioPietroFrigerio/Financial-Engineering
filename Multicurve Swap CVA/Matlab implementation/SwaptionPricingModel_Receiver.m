function SR = SwaptionPricingModel_Receiver(gamma,r,B,beta,a,sigma,time_interval_Z,deltas,time_intervals_v)
% computes price of the single Receiver swaption by using MHW model
% 
% INPUT
